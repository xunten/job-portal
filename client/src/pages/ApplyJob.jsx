...
const ApplyJob = () => {
    ...
    const [isAlreadyApplied, setIsAlreadlyApplied] = useState(false)
    ...
    const checkAlreadyApplied = () => {
        ...
        setIsAlreadlyApplied(hasApplied)
                ...
                <div className='flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl'>
                    ...
                    <div className='flex flex-col justify-center text-end text-sm max-md:mx-auto max-md:text-center'>
                        <button onClick={applyHandler} className='bg-blue-600 p-2.5 px-10 text-white rounded'>{isAlreadyApplied? 'Already Applied':'Apply Now'}</button>
                            <p className='mt-1 text-gray-600'>Posted {moment(Number(JobData.date)).fromNow()}</p>
                    </div>
        ...
        <div className='flex flex-col lg:flex-row justify-between items-start'>
            ...
            <div className='w-full lg:w-1/3 mt-8 lg:mt-0 lg:ml-8 space-y-5'>
                ...
                .filter( job => {
                    ...
                    // Return true if the user has not readly applied for this job
